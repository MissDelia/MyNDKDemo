...
Java_com_example_myndkdemo_Codec_hexEncode(JNIEnv *env, jclass clazz, jbyteArray array) {
...
Java_com_example_myndkdemo_Codec_hexDecode(JNIEnv *env, jclass type, jstring str) {
    jbyteArray ret = NULL;
    if (str != NULL) {
        // TODO
